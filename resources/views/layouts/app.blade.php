        ...
        <div class="background-1">
                <header>
                        <div class="header-left">
                            <img style="margin-left:40px;width:150px; height:auto;" src="{{asset('images/logo.png')}}" alt="">
                        </div>
                    ...
                    <div class="banner">
                        ...
                        <p class="text-center">Tra cứu "SĐT, STK Ngân Hàng..." trước khi giao dịch online. Đây là dữ liệu để cảnh báo không nhắm mục đích bôi nhọ hay hạ thấp uy tín danh dự của bất kì ai, vui lòng liên hệ admin để gỡ thông tin sai sự thật .</p>
