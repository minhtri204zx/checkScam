            ...
            <div class="ac">
                <div class="cangiua">
                    ...
                    <header style="">
                        ...
                        <input type="text" id="search3" value="{{ request()->search }}" name="search"
                            onkeyup="debounceShowHints2(event, this.value)">
                    </form>                       
                                <img class="icon" src="{{ asset('images/icon.png') }}" id="icon" alt="">
                                <a class="btnReport"
                                    @if (!Auth::check()) data-bs-toggle="modal" data-bs-target="#exampleModal" @else href="/posts/create" @endif>Report
                                    lừa
                                    đảo</a>
                ...
                <div class="cangiua">
                    <div id="main" class="slide text-light moved">
                        @foreach ($cates as $cate)
                           <a href="/posts?cate={{$cate['id']==4?'':$cate['id']}}">
